...
Backtracking is a recursive technique where you:
Make a choice (e.g., add '(' or ')').
Explore further using recursion.
Undo the choice (backtrack) to try a different one.
