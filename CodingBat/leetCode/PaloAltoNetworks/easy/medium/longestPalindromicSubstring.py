...
Why rp = i + 1?
Because:
In even-length palindromes, there’s no single middle character.
The center is between two equal characters, so you start with i and i+1 as left and right pointers.
If you used lp = i, rp = i like in the odd case, you would miss all even-length palindromes entirely.
